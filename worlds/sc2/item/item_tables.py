...
item_table = {
    ...
    item_names.DARK_TEMPLAR_SHROUD_OF_ADUN: ItemData(353 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_2, 23, SC2Race.PROTOSS, parent=parent_names.DARK_TEMPLAR_CLASS),
    item_names.AVENGER_SHADOW_GUARD_TRAINING: ItemData(354 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_2, 24, SC2Race.PROTOSS, parent=parent_names.DARK_TEMPLAR_CLASS),
    item_names.DARK_TEMPLAR_BLINK: ItemData(355 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_2, 25, SC2Race.PROTOSS, classification=ItemClassification.progression, parent=parent_names.DARK_TEMPLAR_CLASS),
    item_names.DARK_TEMPLAR_RESOURCE_EFFICIENCY: ItemData(356 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_2, 26, SC2Race.PROTOSS, parent=parent_names.DARK_TEMPLAR_CLASS),
    ...
    item_names.AVENGER_WAY_OF_RETRIBUTION: ItemData(437 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_5, 17, SC2Race.PROTOSS),
    item_names.AVENGER_ACCELERATED_WARP: ItemData(438 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_5, 18, SC2Race.PROTOSS),
    item_names.AVENGER_STRATEGIC_RETREAT: ItemData(439 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_5, 19, SC2Race.PROTOSS),
    item_names.BLOOD_HUNTER_ESSENCE_DRAIN: ItemData(440 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_5, 20, SC2Race.PROTOSS),
    item_names.BLOOD_HUNTER_FROZEN_IN_AGONY: ItemData(441 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_5, 21, SC2Race.PROTOSS),
    item_names.BLOOD_HUNTER_ALARAKS_CALL: ItemData(442 + SC2LOTV_ITEM_ID_OFFSET, ProtossItemType.Forge_5, 22, SC2Race.PROTOSS),
