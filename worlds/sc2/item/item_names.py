...
SON_OF_KORHAL_THE_PRODIGAL_SON                     = "The Prodigal Son (Son of Korhal)"
SON_OF_KORHAL_SHIELD_OF_THE_DOMINION               = "Shield of the Dominion (Son of Korhal)"
SON_OF_KORHAL_BUILD_A_BOOM                         = "Build-A-Boom (Son of Korhal)"
SON_OF_KORHAL_TOSS_SPIDER_MINE                     = "Toss Spider Mine (Son of Korhal)"
FIELD_RESPONSE_THETA_ROYAL_ACADEMY_DEGREE          = "Royal Academy Degree (Field Response Theta)"
FIELD_RESPONSE_THETA_OPTICAL_RESTORATION           = "Optical Restoration (Field Response Theta)"
FIELD_RESPONSE_THETA_HOSPICE_CARE                  = "Hospice Care (Field Response Theta)"
FIELD_RESPONSE_THETA_PHYSICAL_THERAPY              = "Physical Therapy (Field Response Theta)"
AEGIS_GUARD_SOVEREIGN_NEOSTEEL                     = "Sovereign Neosteel (Aegis Guard)"
AEGIS_GUARD_INCAPACITATOR_SHELLS                   = "Incapacitator Shells (Aegis Guard)"
AEGIS_GUARD_BOLSTERED_BARRIER                      = "Bolstered Barrier (Aegis Guard)"
AEGIS_GUARD_ADDICTIVE_SUPPLEMENTS                  = "Addictive Supplements (Aegis Guard)"
SHOCK_DIVISION_SMART_SERVOS                        = "Smart Servos (Shock Division)"
SHOCK_DIVISION_NAPALM_STRIKE                       = "Napalm Strike (Shock Division)"
SHOCK_DIVISION_RETROFITTED_CANNONS                 = "Retrofitted Cannons (Shock Division)"
SHOCK_DIVISION_ARMAMENT_STABILIZERS                = "Armament Stabilizers (Shock Division)"
BULWARK_COMPANY_MOEBIUS_SHIELDING                  = "Moebius Shielding (Bulwark Company)"
BULWARK_COMPANY_ARES_CLASS_TARGETING_ADDON         = "Ares-Class Targeting Add-on (Bulwark Company)"
BULWARK_COMPANY_JUMP_JETS_MKII                     = "Jump Jets MKII (Bulwark Company)"
BULWARK_COMPANY_NEURAL_SHUTDOWN                    = "Neural Shutdown (Bulwark Company)"
BLACKHAMMER_HAMMER_OF_THE_LAW                      = "Hammer of the Law (Blackhammer)"
BLACKHAMMER_INFERNO_BLITZ                          = "Inferno Blitz (Blackhammer)"
BLACKHAMMER_SMART_SERVOS                           = "Smart Servos (Blackhammer)"
BLACKHAMMER_BULWARK_FIELD                          = "Bulwark Field (Blackhammer)"
EMPERORS_SHADOW_SOVEREIGN_TACTICAL_MISSILES        = "Sovereign Tactical Missiles (Emperor's Shadow)"
EMPERORS_SHADOW_PSYCHIC_ENHANCERS                  = "Psychic Enhancers (Emperor's Shadow)"
EMPERORS_SHADOW_KARESHI_PHASING_SUIT               = "K'areshi Phasing Suit (Emperor's Shadow)"
EMPERORS_SHADOW_NEMESIS_ROUNDS                     = "Nemesis Rounds (Emperor's Shadow)"
...
NIGHT_WOLF_SHOCKWAVE_ARTILLERY                     = "Shockwave Artillery (Night Wolf)"
NIGHT_WOLF_PREYSEEKER_MISSILES                     = "Preyseeker Missiles (Night Wolf)"
NIGHT_WOLF_ENERGIZED_BACKLASH                      = "Energized Backlash (Night Wolf)"
NIGHT_WOLF_ELUSIVE_ROTORS                          = "Elusive Rotors (Night Wolf)"
...
SIEGE_TANK_TRANSPORT_HOOK                          = "Transport Hook (Siege Tank)"
...
MOTHERSHIP_PURIFIER_ENERGIZED_NETWORK                   = "Energized Network (Purifier Mothership)"
MOTHERSHIP_AIUR_FEEDBACK_CONDUCTORS                     = "Feedback Conductors (Aiur Mothership)"
...
PYLON_KHALAI_INGENUITY                                  = "Khalai Ingenuity (Pylon)"
SHIELD_BATTERY_KHALAI_INGENUITY                         = "Khalai Ingenuity (Shield Battery)"
PHOTON_CANNON_ENHANCED_TARGETING                        = "Enhanced Targeting (Photon Cannon)"
PHOTON_CANNON_OPTIMIZED_ORDNANCE                        = "Optimized Ordnance (Photon Cannon)"
PHOTON_CANNON_KHALAI_INGENUITY                          = "Khalai Ingenuity (Photon Cannon)"
PHOTON_CANNON_REPULSOR_SHELL                            = "Repulsor Shell (Photon Cannon)"
PHOTON_CANNON_PHASE_CANNON                              = "Phase Cannon (Photon Cannon)"
KHAYDARIN_MONOLITH_OPTIMIZED_ORDNANCE                   = "Optimized Ordnance (Khaydarin Monolith)"
KHAYDARIN_MONOLITH_KHALAI_INGENUITY                     = "Khalai Ingenuity (Khaydarin Monolith)"
