...
item_descriptions = {
    ...
    item_names.MIRAGE_PHASE_ALIGNMENT: "Reduces the cooldown of Phase Armor by 1 second.",
    ...
    item_names.SKIRMISHER_TERRAZINE_INJECTORS: _ability_desc("Skirmishers", "Terrazine Injectors", "massively increases attack speed at the cost of losing life points over time. Attack speed bonus decays over the duration"),
