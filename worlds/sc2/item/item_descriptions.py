...
item_descriptions = {
    ...
    item_names.SENSOR_TOWER_MULTISPECTRUM_DOPPLER: "Sensor Towers gain +10 sight range and +5 radar range.",
    ...
    item_names.SHOCK_DIVISION_SMART_SERVOS: "Shock Divisions transform between Tank Mode and Siege Mode 3 times as fast.",
    item_names.SHOCK_DIVISION_NAPALM_STRIKE: "Shock Divisions in Siege Mode ignite the ground with their attacks, with size based on splash radius.",
    item_names.SHOCK_DIVISION_RETROFITTED_CANNONS: "Shock Divisions in Tank Mode deal splash damage with their attacks,\nand the Tank Mode weapon benefits from Siege Mode Rank bonus effects.",
    item_names.SHOCK_DIVISION_ARMAMENT_STABILIZERS: "Allows a Shock Division in Siege Mode to attack air units while loaded in a Medivac.",
    item_names.BULWARK_COMPANY_MOEBIUS_SHIELDING: "Grants the Bulwark Company 60 shields. Shield regeneration increases each Rank.",
    item_names.BULWARK_COMPANY_ARES_CLASS_TARGETING_ADDON: "At Rank 2, increases the Bulwark Company's anti-air attack range by 2\nand ground attack range by 1.",
    item_names.BULWARK_COMPANY_JUMP_JETS_MKII: "Allows the Bulwark Company to jump up and down cliffs. Increases the range of its Jump Jets ability by 33%.",
    item_names.BULWARK_COMPANY_NEURAL_SHUTDOWN: "Lockdown Missiles also stun Biological targets.",
    item_names.BLACKHAMMER_HAMMER_OF_THE_LAW: "Reduces the windup of Thor's Hammer and causes it to deal splash damage in a small area around its target.",
    item_names.BLACKHAMMER_INFERNO_BLITZ: "Attacks in Overwatch Mode grant ramping attack speed.",
    item_names.BLACKHAMMER_SMART_SERVOS: "Blackhammers transform between Walker Mode and Overwatch Mode 3 times as fast.",
    item_names.BLACKHAMMER_BULWARK_FIELD: "Blackhammers grant armor to nearby friendly ground units, with a larger bonus in Overwatch Mode.",
    ...
    item_names.NIGHT_WOLF_SHOCKWAVE_ARTILLERY: "Night Wolf attacks do splash damage in a line, with length scaling by Rank.",
    item_names.NIGHT_WOLF_PREYSEEKER_MISSILES: "Increases Night Wolf weapon and Apocalypse Now! range, and increases missile speed.",
    item_names.NIGHT_WOLF_ENERGIZED_BACKLASH: "Night Wolves restore energy whenever they fire a missile.",
    item_names.NIGHT_WOLF_ELUSIVE_ROTORS: "Night Wolves take reduced damage while moving.",
    ...
    item_names.MOTHERSHIP_TALDARIM_SUMMON_DEATH_FLEET: "Allows Tal'darim Motherships to summon 6 Destroyers with timed life. Costs resources to install.",
    item_names.MOTHERSHIP_PURIFIER_PLANET_CRACKER: "Allows Purifier Motherships to deal massive damage to ALL OTHER UNITS\nin an increasing area after a brief delay. Costs resources to install.",
    ...
    item_names.MOTHERSHIP_AIUR_KHALAI_SHIELD_RECHARGERS: "The Aiur Mothership's weapon will restore shields\nto nearby friendly units when it deals damage. Costs resources to research.",
    item_names.MOTHERSHIP_AIUR_FEEDBACK_CONDUCTORS: "Aiur Mothership abilities will cast Feedback on a nearby enemy unit. Costs resources to research.",
    item_names.MOTHERSHIP_AIUR_SYMBOL_OF_UNITY: "Aiur Motherships grant increased energy regeneration to nearby friendly units,\nincreased for Aiur units. Costs resources to research.",
    item_names.MOTHERSHIP_TIME_FIELD_MODULES: "Allows Motherships to create a large field that manipulates the battlefield,\nwith each Mothership having different effects. Costs resources to install.",
    item_names.MOTHERSHIP_WORMHOLE_MODULES: "Allows Aiur Motherships to use Nexus Recall, Purifier Motherships to use Mass Recall,\nand Taldarim Motherships to use Wormhole Transit. Costs resources to install.",
    item_names.MOTHERSHIP_HANGAR_INSTALLATIONS: "Allows Motherships to install a Hangar to house support drones,\nwith each Mothership having different drones. Costs resources to research.",
    ...
    item_names.ARTANIS_PHASE_PRISM: "Artanis stuns a unit, swaps places with them, and then pulls nearby enemies to himself. He then gains temporary shields.",
    ...
    item_names.ARTANIS_RESURGENCE: "When Artanis takes lethal damage, he becomes invulnerable, unleashes a shockwave\nwhich damages and knocks back nearby enemies, then revives at full health.",
    ...
    item_names.ARTANIS_STRENGTH_IN_UNITY: "Artanis grants bonuses to nearby friendly units based on the Protoss factions around him.",
    item_names.ARTANIS_SUPPRESSION_PULSE: "Artanis deals damage to nearby enemies and reduces their weapon damage.",
    item_names.ARTANIS_EXTERMINATE: "Tal'darim Aspect Active. Artanis charges his target and begins attacking them with increased damage.",
    item_names.ARTANIS_MALASHS_MALEVOLENCE: "Tal'darim Aspect Passive. Artanis' attacks deal an additional damage to nearby enemy units around his target.",
    item_names.ARTANIS_CLEANSING_SMITE: "Purifier Aspect Active. Artanis deals damage to nearby enemies, then damages nearby enemies over time for a few seconds. Partially restores shields equal to damage done.",
    item_names.ARTANIS_CLOLARIONS_CONFIDENCE: "Purifier Aspect Passive. Whenever Artanis takes damage, he deals damage to a nearby enemy. Can only occur once per second.",
    item_names.ARTANIS_SHADOW_SLICE: "Nerazim Aspect Active. Artanis quickly teleports behind an enemy and deals damage to them before teleporting back. This ability's cooldown and cost are partially refunded if it kills the targeted enemy.",
    item_names.ARTANIS_RASZAGALS_RHYTHM: "Nerazim Aspect Passive. When Artanis uses an ability, his next attack deals additional damage,\nrestores energy, and reduces his ability cooldowns.",
    item_names.ARTANIS_BLADE_WALTZ: "Aiur Aspect Active. Artanis dashes forward, dealing damage to all enemies he passes through\nand additional damage to enemies near the end of the dash.",
    item_names.ARTANIS_TASSADARS_TEACHINGS: "Aiur Aspect Passive. When Artanis deals damage, he deals an additional 12 damage.",
