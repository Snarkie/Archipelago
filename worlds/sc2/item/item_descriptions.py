...
item_descriptions = {
    ...
    item_names.IMMORTAL_WARP_RELOCATE: _ability_desc("Immortals", "Warp Relocate", "warps to a nearby location"),
    item_names.IMMORTAL_COUNTERMEASURES: "Immortals deal damage to enemy units attacking them, while their Barrier is active.",
    item_names.IMMORTAL_ETERNAL_DUTY: "Up to twice per mission, upon building a Robotics Facility, warp in an Immortal immediately.\nThese Immortals do not use supply.",
