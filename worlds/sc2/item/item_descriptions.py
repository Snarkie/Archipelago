...
item_descriptions = {
    ...
    item_names.INFESTED_MARINE_ENDURING_STRAIN: "Infested Marines last 30 seconds longer.",
    item_names.INFESTED_MARINE_LEG_ENHANCEMENTS: "Infested Marines move faster while off-creep.",
